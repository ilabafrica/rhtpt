            ...
            <div class="modal-content">
                ...
                <div class="row">
                    <div class="modal-body">
                        ...
                        <form method="POST" enctype="multipart/form-data" v-on:submit.prevent="createFacility('create_facility')" id="create_facility" data-vv-scope="create_facility">
                            <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 form-control-label"  :class="{'help is-danger': errors.has('create_facility.name') }" for="name">Name:</label>
                                    <div class="col-sm-8" :class="{ 'control': true }">
                                        <input v-validate="'required|alpha_spaces'" class="form-control" :class="{'input': true, 'is-danger': errors.has('create_facility.name') }" name="name" type="text" placeholder="" v-model="newFacility.name" />
                                        <span v-show="errors.has('create_facility.name')" class="help is-danger">@{{ errors.first('create_facility.name') }}</span>
                                    </div>
                                </div> 
                                <div class="form-group row">
                                    <label class="col-sm-4 form-control-label" for="reg no.">Registration No.:</label>
                                    <div class="col-sm-8">
                                        <input class="form-control" name="reg no." type="text" placeholder="" v-model="newFacility.registration_number" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 form-control-label" for="title">Address:</label>
                                    <div class="col-sm-8">
                                        <textarea name="address" class="form-control" v-model="newFacility.mailing_address"></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 form-control-label" for="incharge">Facility In-Charge:</label>
                                    <div class="col-sm-8" :class="{ 'control': true }">
                                        <input v-validate="'required|alpha_spaces'" class="form-control" :class="{'input': true, 'is-danger': errors.has('in charge') }" name="in charge" type="text" placeholder="" v-model="newFacility.in_charge" />
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8" :class="{ 'control': true }">
                                        <input v-validate="'required|numeric'" class="form-control" :class="{'input': true, 'is-danger': errors.has('phone') }" name="phone" type="text" placeholder="" v-model="newFacility.in_charge_phone" />
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8" :class="{ 'control': true }">
                                        <input v-validate="'required|email'" class="form-control" :class="{'input': true, 'is-danger': errors.has('email') }" name="email" type="text" placeholder="" v-model="newFacility.in_charge_email" />
                               ...
                               <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control c-select" name="sub_county_id" id="sub_county_id" v-model="newFacility.sub_county_id">
                                            <option selected></option>
