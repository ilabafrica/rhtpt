...
<div class="card">
	<div class="card-header">
  	...
  	<div class="card-block">
        ...
        @endif
		<div class="row">
			{!! Form::model($receipt, array('route' => array('receipt.update', $receipt->id), 'method' => 'PUT', 'id' => 'form-edit-receipt', 'class' => 'form-horizontal')) !!}
			<!-- CSRF Token -->
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
              {!! Form::select('shipment', array(''=>trans('messages.select'))+$shipments, $shipment, array('class' => 'form-control c-select', 'id' => 'item')) !!}
            </div>
        </div>
        <div class="form-group row">
