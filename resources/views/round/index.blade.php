    ...
    <table class="table table-bordered">
        ...
        <tr v-for="round in rounds">
            ...
            @permission('enrol-participants')
                ...
                <button v-if="!round.deleted_at" class="btn btn-sm wisteria" v-show="round.end_date > isDateCurrent" data-toggle="modal" data-target="#load-participants" @click.prevent="Participants(round.id)" ><i class="fa fa-list"></i> Load Participants</button>
