...
<div class="card">
	<div class="card-header">
  	...
  	<div class="card-block">
        ...
        @endif
		<div class="row">
			{!! Form::open(array('route' => 'expected.store', 'id' => 'form-add-expected', 'class' => 'form-horizontal')) !!}
			<!-- CSRF Token -->
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
              {!! Form::select('item', array(''=>trans('messages.select'))+$items, '', array('class' => 'form-control c-select', 'id' => 'item')) !!}
            </div>
        </div>
				<div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
              {!! Form::select('tested_by', array(''=>trans('messages.select'))+$users, '', array('class' => 'form-control c-select', 'id' => 'tested_by')) !!}
            </div>
        </div>
