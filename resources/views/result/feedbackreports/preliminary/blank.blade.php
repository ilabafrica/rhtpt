...
<table class="table table-bordered" cellspacing="0" style="font-size:15px">
    ...
    <tr>
        <td style ="border:solid 1px black;" colspan="5">
            To successfully submit Your Results Online, follow the procedure below.    
            <br/>1. Go to www.rhtpt.or.ke
            <br/>2. Log in to your Account (Use your Tester ID (Username) and password you had created.
            <br/>3. Click <b>"Proficiency Testing"</b>
            <br/>4. Click <b>"Results"</b>.... Click <b>"OK"</b> when a prompt appears saying <b>"No data found"</b>
            <br/>5. Click on the blue button ....<b>"Enter Results".</b>
            <br/>6. Populate <b>all required fields</b> on the Results page and click the submit button
            <br/>7. Click on the Verify button to verify/Edit your Resuslts & Click  <b>"Submit"</b> to ensure your results are received at NPHL
        </td>
    <tr>
