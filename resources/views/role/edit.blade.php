...
<div class="card">
	<div class="card-header">
	    <i class="fa fa-edit"></i> {!! trans('messages.new').' '.trans_choice('menu.role', 1) !!}
	    <span>
  	...
  	<div class="card-block">
        ...
        @endif
		<div class="row">
			{!! Form::model($role, array('route' => array('role.update', $role->id), 'method' => 'PUT', 'id' => 'form-edit-role', 'class' => 'form-horizontal')) !!}
			<!-- CSRF Token -->
